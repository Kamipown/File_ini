...
int		main(int argc, char *argv[])
{
	...
	std::cout << test_ini.get_string_value("width") << std::endl;
	std::cout << test_ini.get_string_value("height") << std::endl;
	std::cout << test_ini.get_string_value("fullscreen") << std::endl;
